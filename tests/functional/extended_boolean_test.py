...
class BooleanExtendedTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_search_known_response(self):
        ...
        some_expected_results = [Result(os.path.abspath("../static/files/d1.txt"), 0.564),
                                 Result(os.path.abspath("../static/files/d3.txt"), 0.180),
                                 Result(os.path.abspath("../static/files/d15.txt"), 0.308),
                                 Result(os.path.abspath("../static/files/d11.txt"), 0.179)]
